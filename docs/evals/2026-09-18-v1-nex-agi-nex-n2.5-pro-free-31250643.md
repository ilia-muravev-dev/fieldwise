# Eval 31250643 — v1 / nex-agi/nex-n2.5-pro:free
...
Run at 2026-09-18 14:06 UTC · v1 baseline, re-scored after the golden parser fix (Rp. prefix)

## Summary

| Metric | Value |
| --- | ---: |
| Field accuracy (strict, every leaf) | 84.5% |
| Value accuracy (leaves with a golden value) | 86.3% |
| Field accuracy (lenient: fuzzy text counts) | 85.6% |
| Documents fully correct | 36.8% |
...
| `total` | money | 19 | 78.9% | 57-91 | 77.8% (18) | 3 | 1 | 0 |
...
| `cash_paid` | money | 19 | 89.5% | 69-97 | 85.7% (14) | 2 | 0 | 0 |
...
| `line_items[].line_total` | money | 46 | 73.9% | 60-84 | 85.0% (40) | 6 | 0 | 6 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `line_items` | 19 | 42.1% | 23-64 | 65.2% | 75.0% | 40 / 46 |
